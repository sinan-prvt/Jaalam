      ...
      <footer className="bg-[#0A1128] py-20 px-6 text-center border-t border-white/10">
        ...
        {viewProductsPage && (
          <div className="fixed inset-0 z-[300] bg-[#0A1128] overflow-y-auto animate-in fade-in">
            <div className="min-h-screen theme-root flex flex-col py-24 px-6 relative bg-[url('https://images.unsplash.com/photo-1534438327276-14e5300c3a48?auto=format&fit=crop&w=1920&q=80')] bg-cover bg-center bg-fixed bg-blend-overlay bg-[#0A1128]/95">
