...
export default function PunjabiRoyalLayout({ content, website }: WeddingLayoutProps) {
  ...
  const sectionMap: Record<string, React.ReactNode> = {
    hero: (
      <section
        key="hero"
        className="relative w-full flex flex-col justify-center items-center text-center bg-[#2B0A0F] text-white p-0 overflow-hidden py-14 sm:py-20 min-h-[95vh]"
      >
        <style>{`
        ...
        <div className="absolute inset-0 z-0 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-[#4A0B19] via-[#2B0A0F] to-[#140205] opacity-95" />
    ...
    about: (
      <section key="about" className="py-14 sm:py-20 px-4 sm:px-6 relative z-10 text-center max-w-4xl mx-auto bg-[#2B0A0F] text-white font-cinzel">
        <div className="max-w-3xl mx-auto bg-[#3A0D14]/90 backdrop-blur-md rounded-[2.5rem] p-8 sm:p-14 shadow-[0_20px_50px_rgba(0,0,0,0.9)] border-2 border-[#FFD700]/50 relative overflow-hidden">
    ...
    story: (
      <section key="story" className="py-14 sm:py-20 px-4 sm:px-6 relative z-10 text-center max-w-4xl mx-auto bg-[#2B0A0F] font-cinzel">
        <div className="max-w-3xl mx-auto bg-[#3A0D14]/90 backdrop-blur-md rounded-[2.5rem] p-8 sm:p-14 shadow-[0_20px_50px_rgba(0,0,0,0.9)] border-2 border-[#FFD700]/50 relative overflow-hidden">
  ...
  return (
    <div className={`min-h-screen bg-[#2B0A0F] relative font-serif text-slate-100 flex flex-col items-center overflow-hidden w-full ${!isOpened ? 'max-h-screen overflow-hidden' : ''}`}>
      ...
      >
        ...
        <div
          ...
          style={{ backgroundImage: "url('/images/punjabi_bg.png')", backgroundSize: 'cover', backgroundPosition: 'center' }}
        >
          ...
          <div className="w-52 h-52 sm:w-64 sm:h-64 rounded-full bg-gradient-to-br from-[#D4AF37] via-[#F5D77F] to-[#AA7C11] p-3 shadow-[0_0_60px_rgba(212,175,55,0.35)] border-2 border-[#FFF2B2] transition-transform duration-500 hover:scale-105 active:scale-95 group flex flex-col items-center justify-center text-center relative overflow-hidden">
            ...
            <div className="w-full h-full rounded-full border-2 border-[#D4AF37]/50 flex flex-col items-center justify-center p-4 bg-[#0D0E12]/90 backdrop-blur-md shadow-inner relative z-10">
              ...
              <div className="w-20 h-20 mb-2 mt-4 relative z-20">
                <img src="/images/punjabi_emblem.png" alt="Punjabi Emblem" className="w-full h-full object-contain drop-shadow-[0_2px_10px_rgba(255,215,0,0.6)]" />
              </div>

              <span className="text-2xl sm:text-3xl font-script-alex text-[#FFD700] font-normal leading-tight">
