...
export default function PunjabiGoldenElegantLayout({ content, website }: WeddingLayoutProps) {
  ...
  const sectionMap: Record<string, React.ReactNode> = {
    hero: (
      <section
        key="hero"
        className="relative w-full flex flex-col justify-center items-center text-center bg-[#FDFBF7] text-[#4A0E1B] p-0 overflow-hidden py-14 sm:py-20 min-h-[95vh]"
      >
        <style>{`
        ...
        {/* Ambient Warm Ivory Background */}
        <div className="absolute inset-0 z-0 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-[#FDFBF7] via-[#FFFDF9] to-[#F5EFDF] opacity-95" />
        ...
        <div className="absolute inset-0 pointer-events-none overflow-hidden z-10">
          {[...Array(14)].map((_, i) => {
            ...
            return (
              <div
                key={i}
                className="absolute top-[-5%] w-3 h-3 rounded-full bg-gradient-to-tr from-[#D4AF37] to-[#FFF2B2] opacity-70 filter blur-[0.5px]"
                style={{
                  left: `${leftPos}%`,
        ...
        <div className="relative z-20 max-w-xs sm:max-w-md md:max-w-lg mx-auto flex flex-col items-center px-4 pb-6 font-cinzel">
          ...
          <p className="text-[#8A2132] text-[10px] sm:text-xs font-semibold tracking-[0.35em] uppercase mb-4 drop-shadow-sm">
          ...
          <div className="flex flex-col items-center leading-none my-1">
            {groomWords.map((word: string, idx: number) => (
              <h1 key={idx} className="text-4xl sm:text-6xl md:text-7xl font-black tracking-[0.2em] text-[#4A0E1B] uppercase drop-shadow-sm my-0.5">
                {word}
              </h1>
            ))}
          </div>
          ...
          <p className="text-[#8A2132] text-[11px] sm:text-xs font-sans tracking-[0.25em] uppercase font-bold max-w-xs sm:max-w-md mx-auto mb-6 leading-relaxed">
            {quoteText}
          </p>

          {/* Date & Time Breakdown Box */}
          <div className="relative z-20 bg-white/95 border-2 border-[#D4AF37]/30 rounded-2xl px-6 py-4 backdrop-blur-md shadow-lg flex flex-col items-center my-2 text-[#4A0E1B]">
            <span className="text-xs sm:text-sm font-bold tracking-[0.3em] uppercase text-[#D4AF37] mb-1">
              {monthStr}
            </span>
            <div className="flex items-center justify-center gap-4 my-1">
              <span className="text-xs sm:text-sm font-semibold tracking-widest uppercase text-[#8A2132]">
                {dayName}
              </span>
              <span className="text-3xl sm:text-4xl font-black px-4 border-x-2 border-[#D4AF37]/50 text-[#4A0E1B]">
                {dayNum}
              </span>
              <span className="text-xs sm:text-sm font-semibold tracking-widest uppercase text-[#8A2132]">
          ...
          {/* Venue Line */}
          <div className="flex items-center justify-center gap-2 text-xs sm:text-sm font-semibold text-[#4A0E1B] uppercase tracking-widest mt-6 max-w-xs text-center">
    ...
    about: (
      <section key="about" className="py-14 sm:py-20 px-4 sm:px-6 relative z-10 text-center max-w-4xl mx-auto bg-[#FFFDF9] text-[#4A0E1B] font-cinzel">
        <div className="max-w-3xl mx-auto bg-white/95 backdrop-blur-md rounded-[2.5rem] p-8 sm:p-14 shadow-lg border-2 border-[#D4AF37]/50 relative overflow-hidden">
          ...
          <div className="flex flex-col items-center mb-8 relative z-20">
            ...
            <h2 className="text-2xl sm:text-4xl font-bold text-[#4A0E1B] tracking-widest uppercase">Family Blessings & Invitation</h2>
          ...
          <div className="grid md:grid-cols-2 gap-6 my-4 relative z-20">
            {/* Groom Card */}
            <div className="bg-[#FDFBF7] p-6 sm:p-8 rounded-3xl border border-[#D4AF37]/40 flex flex-col items-center hover:-translate-y-1.5 hover:border-[#D4AF37] hover:shadow-xl transition-all duration-300">
              {groomPhoto ? (
                ...
                <div className="w-24 h-24 sm:w-28 sm:h-28 rounded-full bg-gradient-to-br from-[#FFFDF9] to-[#F5EFDF] border-2 border-[#D4AF37] flex flex-col items-center justify-center mb-4 shadow-sm text-[#4A0E1B]">
              ...
              <h3 className="text-xl sm:text-2xl font-bold text-[#4A0E1B] mb-1">{groomFullName}</h3>
              <p className="text-[11px] text-[#D4AF37] font-bold uppercase tracking-widest mb-1 font-sans">Groom</p>
              {groomParents && <p className="text-xs text-[#8A2132] font-garamond italic">Son of {groomParents}</p>}
            </div>
            ...
            <div className="bg-[#FDFBF7] p-6 sm:p-8 rounded-3xl border border-[#D4AF37]/40 flex flex-col items-center hover:-translate-y-1.5 hover:border-[#D4AF37] hover:shadow-xl transition-all duration-300">
              ...
              <h3 className="text-xl sm:text-2xl font-bold text-[#4A0E1B] mb-1">{brideFullName}</h3>
              <p className="text-[11px] text-[#D4AF37] font-bold uppercase tracking-widest mb-1 font-sans">Bride</p>
              {brideParents && <p className="text-xs text-[#8A2132] font-garamond italic">Daughter of {brideParents}</p>}
            </div>
          </div>
        </div>
      </section>
      ...
      <section key="story" className="py-14 sm:py-20 px-4 sm:px-6 relative z-10 text-center max-w-4xl mx-auto bg-[#FDFBF7] font-cinzel">
        <div className="max-w-3xl mx-auto bg-white/95 backdrop-blur-md rounded-[2.5rem] p-8 sm:p-14 shadow-lg border-2 border-[#D4AF37]/50 relative overflow-hidden">
          <div className="relative z-20">
            ...
            <h2 className="text-2xl sm:text-4xl font-bold text-[#4A0E1B] mb-6 uppercase tracking-widest">
              {storyTitle}
            </h2>
    ...
    schedule: (
      <section key="schedule" className="py-14 sm:py-20 px-4 sm:px-6 relative z-10 text-center max-w-4xl mx-auto bg-[#FFFDF9] font-cinzel">
        <div className="flex flex-col items-center mb-12">
          ...
          <h2 className="text-2xl sm:text-4xl font-bold text-[#4A0E1B] tracking-widest uppercase">Schedule of Events</h2>
        </div>

        <div className="grid md:grid-cols-3 gap-6">
          {schedule.map((item: any, idx: number) => (
            <div key={idx} className="bg-white rounded-3xl p-6 sm:p-8 shadow-sm border-t-4 border-[#D4AF37] border-x border-b border-[#D4AF37]/30 text-center hover:-translate-y-2 hover:shadow-lg transition-all duration-300 relative overflow-hidden">
              <h3 className="text-lg font-bold text-[#4A0E1B] mb-3 relative z-20">{item.event}</h3>
              <div className="flex items-center justify-center gap-2 mb-2 text-[#D4AF37] font-sans relative z-20">
                <Clock className="w-4 h-4 text-[#D4AF37]" />
                <span className="font-semibold text-sm text-[#8A2132]">{item.time}</span>
              </div>
    ...
    venue: (
      <section key="venue" className="py-14 sm:py-20 px-4 sm:px-6 relative z-10 max-w-4xl mx-auto bg-[#FDFBF7] font-cinzel">
        <div className="bg-white/95 rounded-[2.5rem] p-8 sm:p-14 text-center shadow-lg border-2 border-[#D4AF37]/50 relative overflow-hidden">
          <div className="relative z-20">
            <div className="w-14 h-14 bg-[#FFFDF9] rounded-full flex items-center justify-center mx-auto mb-4 shadow-sm border border-[#D4AF37]/40 text-[#D4AF37]">
              <MapPin className="w-7 h-7 text-[#D4AF37] animate-bounce" />
            </div>
            <h3 className="text-2xl sm:text-4xl font-bold text-[#4A0E1B] mb-3 tracking-widest uppercase">Venue & Location</h3>
            <p className="text-lg sm:text-xl font-bold text-[#D4AF37] mb-2">{fullLocation}</p>
            <p className="text-sm text-[#8A2132] max-w-md mx-auto mb-6 font-garamond">We look forward to celebrating our special day with you.</p>

            {venuePhoto && (
              <div className="w-full h-56 sm:h-72 rounded-2xl overflow-hidden shadow-sm border-2 border-[#D4AF37]/30 mb-6 relative group">
            ...
            {contactNumbers && (
              <div className="border-t border-[#D4AF37]/30 pt-6 mt-2">
                ...
                <p className="text-base sm:text-lg font-bold text-[#4A0E1B] font-sans">{contactNumbers}</p>
              </div>
            )}
          </div>
        </div>
    ...
    gallery: validGallery.length > 0 ? (
      <section key="gallery" className="py-14 sm:py-20 px-4 sm:px-6 relative z-10 text-center max-w-4xl mx-auto bg-[#FFFDF9] font-cinzel">
        <div className="flex flex-col items-center mb-12">
          <div className="flex items-center gap-3 mb-2 opacity-90">
          ...
          <h2 className="text-2xl sm:text-4xl font-bold text-[#4A0E1B] tracking-widest uppercase">Photo Gallery</h2>
        </div>

        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          {validGallery.map((url: string, index: number) => (
            <div key={index} className="aspect-square rounded-3xl overflow-hidden shadow-sm border-2 border-[#D4AF37]/30 hover:border-[#D4AF37] hover:scale-105 transition-all duration-500 relative bg-white">
    ...
    countdown: (
      <section key="countdown" className="py-14 sm:py-20 px-4 sm:px-6 relative z-10 max-w-4xl mx-auto bg-[#FDFBF7] font-cinzel">
        <div className="bg-white/95 rounded-[2.5rem] p-8 sm:p-14 text-center shadow-lg border-2 border-[#D4AF37]/50 relative overflow-hidden max-w-2xl mx-auto">
          <div className="flex flex-col items-center mb-8 relative z-20">
            <div className="flex items-center gap-3 mb-2 opacity-90">
              <div className="h-[1px] w-12 bg-[#D4AF37]"></div>
            ...
            <h2 className="text-2xl sm:text-4xl font-bold text-[#4A0E1B] tracking-widest uppercase">Counting Down To The Big Day</h2>
          ...
          <div className="grid grid-cols-4 gap-2 sm:gap-4 max-w-xs sm:max-w-md mx-auto justify-items-center relative z-20">
            {[
              ...
              <div key={idx} className="flex flex-col items-center w-full">
                <div className="w-14 h-14 sm:w-18 sm:h-18 rounded-2xl bg-gradient-to-br from-[#FFFDF9] to-[#F5EFDF] text-[#D4AF37] flex items-center justify-center mb-2 shadow-sm border border-[#D4AF37]/40 hover:scale-105 transition-transform">
                  <span className="text-lg sm:text-2xl font-bold font-sans">{item.value}</span>
                </div>
                <span className="text-[10px] sm:text-xs tracking-widest uppercase font-bold text-[#8A2132] font-sans text-center">{item.label}</span>
              </div>
            ))}
          </div>
        </div>
    ...
    wishes: (
      <section key="wishes" className="py-14 sm:py-20 px-4 sm:px-6 relative z-10 max-w-2xl mx-auto bg-[#FFFDF9] font-cinzel">
        <div className="text-center relative z-20">
          ...
          <div className="flex flex-col items-center mb-6">
            ...
            <h2 className="text-2xl sm:text-4xl font-bold text-[#4A0E1B] tracking-widest uppercase">Send Your Blessings & Wishes</h2>
          ...
          <div className="bg-white/95 backdrop-blur-md rounded-[2.5rem] p-8 md:p-12 shadow-lg border-2 border-[#D4AF37]/50 relative overflow-hidden flex flex-col items-center justify-center text-[#4A0E1B]">
            ...
            <button
              ...
              className={`w-24 h-24 rounded-full bg-gradient-to-tr from-[#D4AF37] to-[#C59B27] border-4 border-white flex items-center justify-center shadow-md transition-all duration-300 group cursor-pointer mb-5 relative z-20 ${pulseRing ? 'scale-110 ring-8 ring-[#D4AF37]/40' : 'hover:scale-105 active:scale-95'}`}
    ...
    registry: (
      <section key="registry" className="py-14 sm:py-20 px-4 sm:px-6 relative z-10 max-w-2xl mx-auto bg-[#FDFBF7] font-cinzel">
        <div className="bg-white/95 backdrop-blur-md rounded-[2.5rem] p-8 md:p-12 shadow-lg border-2 border-[#D4AF37]/50 text-center relative overflow-hidden">
          <Gift size={44} className="text-[#D4AF37] mx-auto mb-4" />
          <h2 className="text-2xl sm:text-4xl font-bold text-[#4A0E1B] tracking-widest uppercase mb-3">Gift Registry</h2>
    ...
    rsvp: (
      <section key="rsvp" className="py-14 sm:py-20 px-4 sm:px-6 relative z-10 max-w-2xl mx-auto bg-[#FFFDF9] font-cinzel">
        <div className="text-center">
          <div className="flex flex-col items-center mb-6">
            ...
            <h2 className="text-2xl sm:text-4xl font-bold text-[#4A0E1B] tracking-widest uppercase">Will You Join Us?</h2>
          ...
          <div className="bg-white/95 backdrop-blur rounded-[2.5rem] p-8 md:p-12 shadow-lg border-2 border-[#D4AF37]/50 text-left relative overflow-hidden">
            <form className="space-y-6 relative z-20 font-sans" onSubmit={(e) => e.preventDefault()}>
              <div className="space-y-5">
                <div>
                  ...
                  <input type="text" className="w-full bg-[#FDFBF7] border border-[#D4AF37]/30 rounded-xl px-4 py-3 outline-none focus:border-[#D4AF37] transition-all text-[#4A0E1B] placeholder-slate-400" placeholder="Your Full Name" />
                </div>

                <div>
                  <label className="block text-xs font-bold tracking-widest uppercase text-[#D4AF37] mb-2">Warm Wishes & Message</label>
                  <textarea rows={4} className="w-full bg-[#FDFBF7] border border-[#D4AF37]/30 rounded-xl px-4 py-3 outline-none focus:border-[#D4AF37] transition-all text-[#4A0E1B] placeholder-slate-400 resize-none" placeholder="Share your warm wishes for the couple..."></textarea>
                </div>
                ...
                <div>
                  ...
                  <div className="flex flex-col sm:flex-row gap-4">
                    <label className="flex items-center gap-3 cursor-pointer p-4 border border-[#D4AF37]/30 hover:border-[#D4AF37] bg-[#FDFBF7] rounded-xl flex-1 transition-colors">
                      ...
                      <span className="text-[#4A0E1B] font-bold uppercase tracking-widest text-xs">Joyfully Accepts</span>
                    </label>
                    <label className="flex items-center gap-3 cursor-pointer p-4 border border-[#D4AF37]/30 hover:border-[#D4AF37] bg-[#FDFBF7] rounded-xl flex-1 transition-colors">
                      <input type="radio" name="attending" className="w-4 h-4 accent-[#D4AF37]" />
                      <span className="text-[#4A0E1B] font-bold uppercase tracking-widest text-xs">Regretfully Declines</span>
                    </label>
                  </div>
                </div>
              </div>
  ...
  return (
    <div className={`min-h-screen bg-[#FDFBF7] relative font-serif text-slate-100 flex flex-col items-center overflow-hidden w-full ${!isOpened ? 'max-h-screen overflow-hidden' : ''}`}>
      ...
      {/* Welcome Screen Interactive Golden Gate */}
      <div
      ...
      >
        {/* Left Golden Door */}
        <div 
          className={`absolute inset-y-0 left-0 w-1/2 bg-cover bg-right bg-no-repeat border-r-[3px] border-[#D4AF37] shadow-2xl transition-transform duration-[1500ms] ease-[cubic-bezier(0.22,1,0.36,1)] ${isOpening ? '-translate-x-full' : 'translate-x-0'}`}
          style={{ backgroundImage: "url('/images/punjabi_golden_elegant_bg.png')" }}
        >
          <div className="absolute inset-0 bg-gradient-to-r from-transparent to-[#FDFBF7]/60 mix-blend-overlay"></div>
        </div>

        {/* Right Golden Door */}
        <div 
          className={`absolute inset-y-0 right-0 w-1/2 bg-cover bg-left bg-no-repeat border-l-[3px] border-[#D4AF37] shadow-2xl transition-transform duration-[1500ms] ease-[cubic-bezier(0.22,1,0.36,1)] ${isOpening ? 'translate-x-full' : 'translate-x-0'}`}
          style={{ backgroundImage: "url('/images/punjabi_golden_elegant_bg.png')" }}
        >
          <div className="absolute inset-0 bg-gradient-to-l from-transparent to-[#FDFBF7]/60 mix-blend-overlay"></div>
        </div>
        ...
        <div className={`relative z-40 flex flex-col items-center justify-center my-auto transition-all duration-[1000ms] ease-[cubic-bezier(0.22,1,0.36,1)] ${isOpening ? 'scale-125 opacity-0 blur-md' : 'scale-100 opacity-100 delay-300'}`}>
          <div className="bg-white/95 backdrop-blur-xl border border-[#D4AF37]/40 p-8 sm:p-14 shadow-2xl rounded-t-[5rem] rounded-b-3xl flex flex-col items-center max-w-sm mx-4 relative overflow-hidden group">
            
            <div className="w-16 h-16 rounded-full border border-[#D4AF37]/30 flex items-center justify-center mb-6 bg-[#FDFBF7] shadow-sm">
               <Sparkles className="text-[#D4AF37] w-6 h-6 animate-pulse" />
            </div>

            <span className="text-5xl sm:text-6xl font-script-alex text-[#4A0E1B] font-normal leading-tight mb-3 drop-shadow-sm flex items-center gap-2">
            ...
            <div className="flex items-center gap-2 mb-8">
               ...
               <span className="text-[10px] uppercase tracking-[0.3em] text-[#4A0E1B] font-bold">Royal Invitation</span>
               <span className="h-[1px] w-6 bg-[#D4AF37]/50"></span>
            </div>

            <button 
              onClick={handleOpen}
              className="bg-gradient-to-r from-[#D4AF37] to-[#C59B27] hover:brightness-110 text-white px-8 py-3.5 rounded-full text-[10px] sm:text-xs font-bold font-sans tracking-[0.2em] uppercase shadow-md active:scale-95 transition-all w-full cursor-pointer relative z-20"
            >
              Enter Celebration
            </button>
          ...
          <h1 className="text-xl sm:text-2xl font-cinzel text-[#4A0E1B] mt-8 font-bold tracking-[0.2em] uppercase drop-shadow-sm text-center">
            {groomFullName} & {brideFullName}
          </h1>
          <p className="text-[#8A2132] text-xs sm:text-sm tracking-[0.25em] font-cinzel uppercase mt-2 font-semibold">
      ...
      {/* Footer */}
      <footer className="py-8 relative z-10 text-center bg-[#FFFDF9] rounded-t-[2.5rem] w-full max-w-4xl mx-auto mt-8 border-t-2 border-[#D4AF37]/30 shadow-[0_-10px_30px_rgba(212,175,55,0.1)]">
        <h2 className="text-2xl font-cinzel mb-2 text-[#D4AF37]">{rawCoupleNames}</h2>
        <p className="text-[#8A2132] text-[10px] tracking-widest uppercase mb-2 font-sans font-bold">Made with love by Jaalam</p>
      </footer>
