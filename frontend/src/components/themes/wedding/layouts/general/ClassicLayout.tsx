    ...
    <div className={`min-h-screen bg-[#FAF6F0] relative font-serif flex flex-col items-center overflow-hidden w-full ${!isOpened ? 'max-h-screen overflow-hidden' : ''}`}>
      ...
      {musicUrl && (
        <button
          ...
          className="fixed bottom-6 right-6 z-50 p-4 rounded-full bg-[#4A3525] text-amber-300 shadow-2xl border border-amber-400/40 hover:scale-110 active:scale-95 transition-all cursor-pointer"
