...
export default function SouthIndianMintLayout({ content, website }: WeddingLayoutProps) {
  ...
  const sectionMap: Record<string, React.ReactNode> = {
    hero: (
      <section key="hero" className="relative w-full min-h-screen flex flex-col items-center justify-center overflow-hidden bg-[#9EDCD6] text-center py-16 px-4">
        ...
        {/* Optional Couple Photo if Uploaded */}
        {coupleImage && (
          <div className="relative z-30 w-full flex justify-center mt-4">
            <div className="relative max-w-[220px] sm:max-w-xs w-full mx-auto flex justify-center">
              <img
                src={coupleImage}
                alt="Couple"
                className="w-full h-auto max-h-[280px] object-contain object-bottom rounded-2xl"
    ...
    about: (
      <section key="about" className="py-20 px-6 relative z-10 max-w-4xl mx-auto bg-[#8ACCC7] text-[#2A4450]">
        <div className="text-center">
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div className="bg-white/85 p-8 rounded-3xl shadow-lg border border-teal-200/50 flex flex-col items-center">
              ...
              <h3 className="text-3xl font-bold text-[#2A4450] mb-2 font-script" style={{ fontFamily: "'Great Vibes', cursive" }}>Groom Family</h3>
            ...
            <div className="bg-white/85 p-8 rounded-3xl shadow-lg border border-teal-200/50 flex flex-col items-center">
              ...
              <h3 className="text-3xl font-bold text-[#2A4450] mb-2 font-script" style={{ fontFamily: "'Great Vibes', cursive" }}>Bride Family</h3>
    ...
    story: (
      <section key="story" className="py-20 px-6 relative z-10 text-center max-w-4xl mx-auto bg-[#9EDCD6]">
    ...
    schedule: (
      <section key="schedule" className="py-20 px-6 relative z-10 text-center max-w-4xl mx-auto bg-[#8ACCC7]">
    ...
    venue: (
      <section key="venue" className="py-20 px-6 relative z-10 max-w-4xl mx-auto bg-[#9EDCD6]">
    ...
    gallery: validGallery.length > 0 ? (
      <section key="gallery" className="py-20 px-6 relative z-10 text-center max-w-4xl mx-auto bg-[#8ACCC7]">
    ...
    rsvp: (
      <section key="rsvp" className="py-16 px-6 relative z-10 max-w-2xl mx-auto bg-[#9EDCD6]">
        <div className="text-center">
