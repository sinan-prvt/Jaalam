          ...
          if (sectionId === 'contact') return (
            <section key="contact" id="contact" className="py-20 px-6 bg-[#F4F4F4]">
                  ...
                  <div className="w-full lg:w-1/2 bg-white p-4 md:p-8 border-4 border-[#1A1A1A] flex flex-col h-full">
                    ...
                    <div className="flex-grow bg-[#F4F4F4] border-4 border-[#1A1A1A] p-6">
                      <ContactForm 
                        ...
                        primaryColor="bg-[#1A1A1A] text-white"
                        primaryColorHover="hover:bg-[#FFC107] hover:text-[#1A1A1A]"
                        inputStyles="bg-white border-2 border-[#1A1A1A] text-[#1A1A1A] placeholder-gray-500 focus:border-[#FFC107] focus:ring-0 rounded-none font-body font-bold"
                        buttonShape="font-industrial text-xl uppercase tracking-wider border-2 border-[#1A1A1A] rounded-none w-full transition-colors"
                      />
                    </div>
                  </div>
                </div>
              ...
              {content.contact_info?.address && (
                <div className="mt-12 container mx-auto max-w-6xl w-full h-80 border-8 border-[#1A1A1A] overflow-hidden relative shadow-[8px_8px_0_#FFC107]">
                  <iframe 
